...
//ol.proj.get("EPSG:4283").setExtent([144.867233, -37.781149, 145.072138, -37.687414]);
var wms_layers = [];
...
lyr_LocalR2values_1.set('fieldLabels', {'source_id': 'no label', 'shape_leng': 'no label', 'shape_area': 'no label', 's_zonalst_': 'no label', 's_meshbloc': 'no label', 's_meshbl_1': 'no label', 's_meshbl_2': 'no label', 's_c_intrcp': 'no label', 's_se_intrc': 'no label', 's_t_intrcp': 'no label', 's_sg_intrc': 'no label', 's_c_meshbl': 'inline label - always visible', 's_se_meshb': 'no label', 's_t_meshbl': 'no label', 's_sg_meshb': 'no label', 's_c_mesh_1': 'inline label - always visible', 's_se_mes_1': 'no label', 's_t_mesh_1': 'no label', 's_sg_mes_1': 'no label', 's_c_mesh_2': 'inline label - always visible', 's_se_mes_2': 'no label', 's_t_mesh_2': 'no label', 's_sg_mes_2': 'no label', 's_predict': 'no label', 'predicted': 'no label', 'c_intrcpt': 'no label', 'c_meshbloc': 'no label', 'c_meshbl_1': 'no label', 'c_meshbl_2': 'no label', 's_residual': 'no label', 's_stdresid': 'no label', 'influence': 'no label', 'cooks_d': 'no label', 'localr2': 'no label', 'cnd_number': 'no label', });
